...
export default function(pi: ExtensionAPI) {
  const tool: ToolDefinition<GlobSchema, GlobDetails, Record<string, never>> = {
    ...
    description: [
      ...
      `Output is capped at ${FILE_LIMIT} results.`,
      "When doing open-ended search requiring multiple rounds of globbing and grepping, use the task tool instead.",
      "You can call multiple tools in a single response — speculatively batch potentially useful searches.",
    ].join("\n"),
